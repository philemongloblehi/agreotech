			...
			do {
				...
				if (choixSousRubrique == 1) {
					...
					case 1:
						...
						Employe monControleur = new Controleur(matricule, nom, prenom, horaireDeTravail, tarifHoraire, "Controleur");
					...
					case 2:
						...
						Employe monManoeuvre = new Manoeuvre(matricule, nom, prenom, horaireDeTravail, tarifHoraire, "Manoeuvre");
